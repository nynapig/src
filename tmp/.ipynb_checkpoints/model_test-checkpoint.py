...
class Encoder(nn.Module):
    def __init__(self):
        ...
        conv1 = ConvINRelu(1, 64, isn=True)
        conv2 = ConvINRelu(64, 128, isn=True)
        conv3 = ConvINRelu(128, 256, isn=True)
        conv4 = ConvINRelu(256, 512, isn=True)
        conv5 = ConvINRelu(512, 512, isn=True)
        conv6 = ConvINRelu(512, 512, isn=True)
        conv7 = ConvINRelu(512, 512, isn=True)
